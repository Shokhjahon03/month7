        ...
        <div className="container">
         ...
         <p className='text-[28.44px] leading-[35.55px] font-semibold'>Sign Up To eatly</p>
          <form onSubmit={submited} className='w-[309.41px] flex flex-col items-center mt-[41px]'>
              ...
              <div className='w-full relative'><input className='w-full rounded-[11.52px] h-[60.09px] pl-[63.68px] text-[13.45px] leading-[20.18px] font-semibold text-[#A2A3A6] bg-[#EEEEEE] mb-[19.73px]' type="email" placeholder='Email' /><i className='bx bx-envelope absolute top-[21.53px] left-[19.73px] text-[#A2A3A6]' ></i></div>
              <div className='w-full relative'><input className='w-full rounded-[11.52px] h-[60.09px] pl-[63.68px] text-[13.45px] leading-[20.18px] font-semibold text-[#A2A3A6] bg-[#EEEEEE] mb-[19.73px]'  type={pas?"password":"text"} placeholder='Password' /><i className='bx bx-lock absolute top-[21.53px] left-[19.73px] text-[#A2A3A6]' ></i><button onClick={()=>setPas(!pas)}><i className='bx bxs-low-vision absolute top-[19.77px] right-[20.16px] text-[#C2C3CB]'></i></button><NavLink className='absolute bottom-0 right-0 text-[11.07px] leading-[16.6px] font-normal text-[#6C5FBC]'>Forget Password ?</NavLink></div>
              <button className='mt-[15px] w-full h-[60.09px] rounded-[12.56px] bg-[#6C5FBC] text-white'>
              SIGN UP
              </button>
          </form>
          <div className='mt-[18.83px] flex'>
          <p className=''>Create A New Account?</p>
          <NavLink className='text-[#6C5FBC]'>Sign UP</NavLink>
          </div>
         </div>
        </div>
      </div>
